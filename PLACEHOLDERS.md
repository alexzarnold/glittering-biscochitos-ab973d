...
### `[[SEMESTER_DATES]]`
**Where:** `meetings.html`, `main.js`
**Replace with:** the semester span in plain language, for example
`Fall 2026 runs from August 24 to December 10`
...
This is the last placeholder with any real thinking behind it. The other four
